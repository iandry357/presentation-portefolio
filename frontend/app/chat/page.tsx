      ...
      setMessages([
        {
          role: 'assistant',
          content:
            "Bonjour ! Je suis l'assistant virtuel d'Iandry (prononcé Yan'ch) RAKOTONIAINA. Posez-moi des questions sur son experience professionnelle, sa formation ou ses projets. Vous pouvez poser 5 questions",
          timestamp: 0,
        },
      ]);
    }
