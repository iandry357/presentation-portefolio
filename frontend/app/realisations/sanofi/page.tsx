  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span>/</span>
        <span className="text-gray-900 font-medium">Sanofi Intelligence</span>
      </div>

      {/* Titre */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Sanofi Intelligence</h1>
        <p className="text-sm text-gray-500">
          Pipeline RAG multi-source — ClinicalTrials.gov · PubMed · Google News
        </p>
      </div>
