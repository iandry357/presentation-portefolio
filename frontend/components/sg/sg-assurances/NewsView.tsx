...
import { fetchSgNews, NewsItem } from '@/lib/sgApi';
...
export default function NewsView() {
  ...
  useEffect(() => {
    setLoading(true);
    fetchSgNews({ limit: PAGE_SIZE, offset: page * PAGE_SIZE })
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-gray-900">Actualités SG Assurances</h2>
