...
from pipeline.config import (
    GCP_PROJECT_ID, GCP_SA_KEY_PATH,
    BQ_DATASET, BQ_TABLE_NEWS,
    CHROMA_HOST, CHROMA_PORT, CHROMA_USER, CHROMA_PASSWORD,
    CHROMA_COLLECTION,
)
...
for dataset, table, label in [
    (BQ_DATASET, BQ_TABLE_NEWS, "google_news"),
]:
    try:
